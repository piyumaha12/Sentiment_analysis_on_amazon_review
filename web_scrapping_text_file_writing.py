...
url_amazon = 'https://www.amazon.in/Redmi-Sky-Blue-64GB-Storage/product-reviews/B08697N43N/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews'
...
def extract_reviews(url_first = None, url_file_location_name = None, review_file_name = None):
    ...
    while True:
        ...
        if i % 5 == 0:
            ...
            file_name = 'reviews_redmi' + str(no_of_reviews) + '.txt'
            with open(file_name, 'w', encoding='utf-8') as file:
                for review in list_of_reviews:
                    file.write(f'{review}')
...
extract_reviews(url_file_location_name= 'url_file_next_page.txt', review_file_name = 'reviews_redmi3650.txt')
